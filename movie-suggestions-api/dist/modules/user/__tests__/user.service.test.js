...
jest.mock('bcrypt');
bcrypt_1.default.hash.mockResolvedValue('fixed-hash');
describe('UserService.createUser', () => {
    ...
    it('should call repository.createUser with parsed data when input is valid', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(bcrypt_1.default.hash).toHaveBeenCalledWith('123456', expect.any(Number));
        expect(repoMock.createUser).toHaveBeenCalledWith(Object.assign(Object.assign({}, validUser), { password: 'fixed-hash' }));
    }));
